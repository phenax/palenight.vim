...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#0f1215", "cterm": "235", "cterm16": "0" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#1f2225", "cterm": "236", "cterm16": "8" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#0a0a0a", "cterm": "59", "cterm16": "15" }),
